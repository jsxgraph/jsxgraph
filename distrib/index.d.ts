...
declare namespace JXG {
    ...
    export class View3D extends GeometryElement {
        ...
        create(elementType: 'curve3d', parents: unknown[], attributes?: Curve3DAttributes): Curve3D;
        create(elementType: 'functiongraph3d', parents: unknown[], attributes?: unknown): unknown;
        create(elementType: 'line3d', parents: unknown[], attributes?: Line3DAttributes): Line3D;
        create(elementType: 'parametricsurface3d', parents: unknown[], attributes?: unknown): unknown;
        create(elementType: 'plane3d', parents: unknown[], attributes?: Plane3DAttributes): Plane3D;
        create(elementType: 'point3d', parents: unknown[], attributes?: Point3DAttributes): Point3D;
        add(el: unknown): void;
        update(): this;
        updateRenderer(): this;
        ...
        getMesh(X: unknown, Y: unknown, Z: unknown, interval_u: unknown, interval_v: unknown): [unknown[], unknown[]];
        animateAzimuth(): void;
        stopAzimuth(): void;
    }
    ...
    export class Board {
        ...
        */
         ...
         * @param attributes
         */
        create(elementType: 'view3d', parents?: unknown[], attributes?: View3DAttributes): View3D;
        /**
        * @param c1
        * @param c2
        * @param start_c1
