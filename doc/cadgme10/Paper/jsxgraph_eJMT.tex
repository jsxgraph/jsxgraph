...
and---at least partially---Cinderella. Further, it provides a programming
...
Usually, JSXGraph is embedded in web pages, for on- and off\/line viewing.
...
addresses the compatibility problems described in Section~\ref{sec:3}.
JSXGraph is a pure JavaScript implementation of dynamic mathematics for the web browser, 
it does not rely on any other library. 
By default, JSXGraph uses the vector graphics format SVG
for graphical output. If SVG is not supported by the web browser it falls
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.8\textwidth]{\imagedir/geonext.png}\\
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.8\textwidth]{\imagedir/geogebra.png}\\
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.8\textwidth]{\imagedir/cindy.png}\\
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.8\textwidth]{\imagedir/jessiescript.png}\\
...
In a last step, JSXGraph displays the locus based on the data points the server sent. An example of the loci computation can
be found on the authors' website: \href{http://jsxgraph.uni-bayreuth.de/examples/limacon.html}{http://jsxgraph.uni-bayreuth.de/examples/limacon.html}.
...
\begin{thebibliography}{99}
    ...
    \bibitem{kaipiainen} Kaipiainen, S., Paksula, M.: 
    ...
    \bibitem{netapplications} Online access to \href{http://marketshare.hitslink.com/browser-market-share.aspx?qprid=0}{http://marketshare.hitslink.com/browser-market-share.aspx?qprid=0} (2010)
