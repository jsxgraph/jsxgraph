...
\frame{
  ...
  \begin{block}{}
    \begin{itemize}
      \item calculate the elimination ideal using the Gr\"obner basis of the given ideal,
\begin{itemize}
...
\begin{center}
      \href{http://localhost/~michael/jxg/examples/adg/limacon.html}{\includegraphics[width=8cm]{img/cubed.png}}
\end{center}
  \end{block}
}
...
\frame{
  ...
  \begin{block}{Transformations}
    \begin{itemize}
      ...
      \item Rotate the construction around the origin, moving another point onto the x-axis
