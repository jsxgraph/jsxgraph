...
\begin{center}
  ...
  \begin{scope}
    \node [place] (E) [label=right:2] {E};
    \node [place] (T) [below of=E, xshift=-60, label=left:2] {T}
      edge [pre] (E);
    \node [place] (D) [below of=T, xshift=-40, label=left:1] {D}
      edge [pre] (T);
    \node [transition] (A) [below of=T, xshift=40] {A}
      edge [pre] (T);
      
    \node [place] (C) [below of=E, xshift=60, label=right:2]  {C}
      edge [pre] (E)
      edge [post] (T);
    \node [transition] (B) [below of=C] {B}
      edge [pre] (C)
