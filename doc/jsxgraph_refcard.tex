...
\metax{axis,grid,showNavigation,showCopyright,zoom,pan:}{\hfill true/false}
\metax{}{show axis, grid, zoom/navigation buttons, display copyright, mouse wheel zoom, shift+mouse panning}
