...
\metax{originX, originY:}{the position of the origin}
...
\section{Slider}
\metax{var s = brd.createElement(\'slider\',}{}
\metax{\phantom{var s = brd.create}[[a,b],[c,d],[e,f,g]],$\{$snapWidth:1$\}$);}{}
...
\metax{snapWidth:num}{distance between 2 values}
...
-- \metax{brd.createElement(\'riemannsum\',[f,n,type],$\{$atts$\}$);}{}
{\sl Riemann sum} of type 'left', 'right', 'middle', 'trapezodial', 'upper', or 'lower'

\section{Tangent, normal}
\metax{var el = brd.createElement(\'tangent\',[g],$\{$attributes$\}$);}{}
\metax{var el = brd.createElement(\'normal\',[g],$\{$attributes$\}$);}{}
...
\metax{el = brd.createElement(\'angle\',[A,B,C],$\{$attributes$\}$);}{}
\par{\sl -- arc:} \hfill circular arc defined by 3 points
\metax{el = brd.createElement(\'arc\',[A,B,C],$\{$attributes$\}$);}{}
\par{\sl -- arrow:} \hfill line through 2 points with arrow head
\metax{el = brd.createElement(\'arrow\',[A,B],$\{$attributes$\}$);}{}
\par{\sl -- arrowparallel:} \hfill arrow parallel to arrow $a$ starting at point $P$
\metax{el = brd.createElement(\'arrowparallel\',[a,P],$\{$atts$\}$);}{}
\metax{el = brd.createElement(\'arrowparallel\',[P,a],$\{$atts$\}$);}{}
\par{\sl -- bisector:} \hfill angular bisector defined by 3 points, returns line
\metax{el = brd.createElement(\'bisector\',[A,B,C],$\{$atts$\}$);}{}
\par{} \hfill angular bisector defined by 2 lines, returns 2 lines
\metax{el = brd.createElement(\'bisectorlines\',[l1,l2],$\{$atts$\}$);}{}
\par{\sl -- circumcircle:} \hfill circle through 3 points (deprecated)
\metax{el = brd.createElement(\'circumcircle\',[A,B,C],$\{$atts$\}$);}{}
\par{\sl -- circumcirclemidpoint:} \hfill center of circle through 3 points
\metax{el = brd.createElement(\'circumcirclemidpoint\',[A,B,C]);}{}
\par{\sl -- midpoint:} midpoint between 2 points or the 2 points defined by a line

\metax{el = brd.createElement(\'midpoint\',[A,B],$\{$atts$\}$);}{}
\metax{el = brd.createElement(\'midpoint\',[line],$\{$atts$\}$);}{}
\par{\sl -- mirrorpoint:} \hfill rotate point $B$ around point $A$ by $180^\circ$
\metax{el = brd.createElement(\'mirrorpoint\',[A,B],$\{$atts$\}$);}{}
\par{\sl -- parallel:} \hfill line parallel to line $l$ through point $P$
\metax{el = brd.createElement(\'parallel\',[l,P],$\{$atts$\}$);}{}
\metax{el = brd.createElement(\'parallel\',[P,l],$\{$atts$\}$);}{}
\par{\sl -- parallelpoint:} \hfill point D such that $ABCD$ from a parallelogram
\metax{el = brd.createElement(\'parallelpoint\',[A,B,C],$\{$atts$\}$);}{}
\par{\sl -- perpendicular:} \hfill line perpendicular to line $l$ through point $P$
\metax{el = brd.createElement(\'perpendicular\',[l,P],$\{$atts$\}$);}{}
\metax{el = brd.createElement(\'perpendicular\',[P,l],$\{$atts$\}$);}{}
\par{\sl -- perpendicularpoint:} \hfill  point defining a perpendicular line to line $l$ through point $P$

\metax{el = brd.createElement(\'perpendicularpoint\',[l,P],$\{$$\}$);}{}
\metax{el = brd.createElement(\'perpendicularpoint\',[P,l],$\{$$\}$);}{}

\par{\sl -- reflection:} \hfill reflection of point $P$ over the line $l$. 
Superseded by transformations

\metax{el = brd.createElement(\'reflection\',[l,P],$\{$atts$\}$);}{}
\metax{el = brd.createElement(\'reflection\',[P,l],$\{$atts$\}$);}{}
\par{\sl -- sector:} \hfill circle sector defined by 3 points \hfill ???
\metax{el = brd.createElement(\'sector\',[A,B,C],$\{$atts$\}$);}{}

\section{Text}
Display static or dynamic texts.\par
\metax{el = brd.createElement(\'text\',[x,y,"Hello"]);}{}
\metax{el = brd.createElement(\'text\',[x,y,f]);}{}
...
\metax{t = brd.createElement(\'transform\',[data,base],$\{$type:\'type\'$\}$);}{}
