...
\metax{el = brd.create(\'text\',[x,y,f]);}{}
Example for a dynamic text: return the $x$ coordinate of the point $p$.\par
\metax{f = function()$\{$ return p.X(); $\}$}{}

\section{Image}
Display bitmap image (also as data uri).\par
\metax{el = brd.create(\'image\',[uri-string,[x,y],[w,h]]);}{}
\metax{}{Optional: {\tt [x,y]} top-left position, {\tt [w,h]} width, height}
...
{\sl Attributes for polygons elements:}\par
