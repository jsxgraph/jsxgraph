...
Three parts are needed: Program files containing the software, an HTML element, and 
JavaScript code.
...
\metax{{\tt brd.createElement('graph',[parents],$\{$attributes$\}$);}}{}
...
\metax{$x$ function, $y$ function [, variable name, start, end]}{}
