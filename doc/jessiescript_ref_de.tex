...
Einfache mathematische JSXGraph-Konstruktionen können
mit dem Befehl
\begin{verbatim}
     board.construct(...);
\end{verbatim}
erzeugt werden. Dabei können verschiedene Elemente, durch
...
mit allen erzeugten Elementen zurück, sodass danach noch
...
Der Zugriff auf die Elemente nach dem Konstruieren ist möglich
über: \\
\begin{tabular}
...
\section{Makros}
Zusätzlich können Makros definiert werden. Schlüsselwort ist \verb+Marco+, die Parameter werden, durch Komma getrennt,
in runden Klammern übergeben, der Inhalt innerhalb von geschweiften Klammern. Links vom Zuweisungsoperator kann ein
beliebiger Name für das Makro übergeben werden. \\ Die entsprechende
Syntax ist also
\begin{verbatim}
