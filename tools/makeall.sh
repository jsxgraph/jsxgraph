...
gs -sDEVICE=pdfwrite -dBATCH -dNOPAUSE -sOutputFile=jsxgraph_refcard.pdf
cp jsxgraph_refcard.pdf ../distrib
cd ..
#
rm -f tools/jsxgraph0.81.zip
zip tools/jsxgraph0.81.zip src/*.js src/COPYING src/COPYING.LESSER distrib/jsxgraphcore.js distrib/jsxgraph.css distrib/prototype.js distrib/*Reader.js tools/makeDistrib.py distrib/jsxgraph_refcard.pdf
