define([
  ...
  registerSuite({
    ...
    isPoint_objectWithElementClassPropertySetToOBJECT_CLASS_POINT_returnsTrue:
      function () {
    ...
    createEvalFunction_mockBoardAndSingleParam_returnsStubFunction:
      function () {
        var evalFunctionResult = 4,
          mockBoard = {
            jc: {
              snippet: sinon.stub().returns(function () {
    ...
    createFunction_mockBoardAndStringEvaluatedByJC_returnsStubFunction:
      function () {
    ...
    createFunction_mockBoardAndNumber_returnsFunctionThatReturnsNumber:
      function () {
    ...
    createFunction_mockBoardAndString_returnsFunctionThatReturnsString:
      function () {
