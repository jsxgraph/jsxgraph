define(["intern!object", "intern/chai!assert", "utils/color"], function (
  registerSuite,
  assert,
  Color
) {
  ...
  registerSuite({
    ...
    rgbParser_threeFloatNumbersBetween0And1_threeNumbersBetween0And255:
      function () {
    ...
    rgbParser_css3DigitHexColorWithMax3SpacesInbetween_ignoresSpaces:
      function () {
        var input = "#a 9  3",
          actual = Color.rgbParser(input),
          expected = [170, 153, 51];
    ...
    rgb2LMS_red_returnsLMS: function () {
      var actual = Color.rgb2LMS("#f00"),
        expected = [
          0.7081423563792175, 0.2649291211696994, 0.040893539132190786,
        ];
    ...
    rgb2LMS_green_returnsLMS: function () {
      var actual = Color.rgb2LMS("#0f0"),
        expected = [
          1.2015185493795306, 1.2490928602982028, 0.13655325673517216,
        ];
    ...
    LMS2rgb_red_returnsRGBArray: function () {
      var actual = Color.LMS2rgb(
          0.7081423563792175,
          0.2649291211696994,
          0.040893539132190786
        ),
        expected = [254, 0, -0.5];
