...
this.ggbAct = function(type, m, n, p) {
  ...
  switch(type.toLowerCase()) {
    ...
    break;
    case 'coord':
      var s1 = (board.ggbElements[v1]) ? JXG.getReference(JXG.GeogebraReader.board, v1) : v1;
      var s2 = (board.ggbElements[v2]) ? JXG.getReference(JXG.GeogebraReader.board, v2) : v2;

      JXG.GeogebraReader.debug("<br/><b>Aktualisierung des Punktes:</b> <li>x["+typeof s1 +": "+ s1 +"]</li><li>y["+typeof s2 +": "+ s2 +"]</li>");
      p.addConstraint([
          new Function('return '+s1+';'),
          new Function('return '+s2+';')
        ]);
      return p;
    break;
...
/***** begin replace *****/
	...
	switch( state )
	{
	    ...
	    case 14:
	        if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 90 ) || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 122 ) ) state = 14;
	...
	var act_tab = new Array(
	    /* State 0 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 1 */ new Array( 28/* "$" */,0 ),
	    /* State 2 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,17 , 17/* "+" */,18 , 16/* ">" */,19 , 15/* "<" */,20 , 14/* "!=" */,21 , 13/* "==" */,22 , 12/* ">=" */,23 , 11/* "<=" */,24 , 18/* "," */,25 , 28/* "$" */,-1 ),
	    /* State 3 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 4 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 5 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 6 */ new Array( 17/* "+" */,29 , 28/* "$" */,-24 , 18/* "," */,-24 , 11/* "<=" */,-24 , 12/* ">=" */,-24 , 13/* "==" */,-24 , 14/* "!=" */,-24 , 15/* "<" */,-24 , 16/* ">" */,-24 , 19/* "-" */,-24 , 21/* "^" */,-24 , 22/* "||" */,-24 , 23/* "&&" */,-24 , 24/* "*" */,-24 , 25/* "/" */,-24 , 3/* ")" */,-24 ),
	    /* State 7 */ new Array( 28/* "$" */,-20 , 18/* "," */,-20 , 11/* "<=" */,-20 , 12/* ">=" */,-20 , 13/* "==" */,-20 , 14/* "!=" */,-20 , 15/* "<" */,-20 , 16/* ">" */,-20 , 17/* "+" */,-20 , 19/* "-" */,-20 , 21/* "^" */,-20 , 22/* "||" */,-20 , 23/* "&&" */,-20 , 24/* "*" */,-20 , 25/* "/" */,-20 , 3/* ")" */,-20 ),
	    /* State 8 */ new Array( 28/* "$" */,-21 , 18/* "," */,-21 , 11/* "<=" */,-21 , 12/* ">=" */,-21 , 13/* "==" */,-21 , 14/* "!=" */,-21 , 15/* "<" */,-21 , 16/* ">" */,-21 , 17/* "+" */,-21 , 19/* "-" */,-21 , 21/* "^" */,-21 , 22/* "||" */,-21 , 23/* "&&" */,-21 , 24/* "*" */,-21 , 25/* "/" */,-21 , 3/* ")" */,-21 ),
	    /* State 9 */ new Array( 28/* "$" */,-22 , 18/* "," */,-22 , 11/* "<=" */,-22 , 12/* ">=" */,-22 , 13/* "==" */,-22 , 14/* "!=" */,-22 , 15/* "<" */,-22 , 16/* ">" */,-22 , 17/* "+" */,-22 , 19/* "-" */,-22 , 21/* "^" */,-22 , 22/* "||" */,-22 , 23/* "&&" */,-22 , 24/* "*" */,-22 , 25/* "/" */,-22 , 3/* ")" */,-22 ),
	    /* State 10 */ new Array( 28/* "$" */,-23 , 18/* "," */,-23 , 11/* "<=" */,-23 , 12/* ">=" */,-23 , 13/* "==" */,-23 , 14/* "!=" */,-23 , 15/* "<" */,-23 , 16/* ">" */,-23 , 17/* "+" */,-23 , 19/* "-" */,-23 , 21/* "^" */,-23 , 22/* "||" */,-23 , 23/* "&&" */,-23 , 24/* "*" */,-23 , 25/* "/" */,-23 , 3/* ")" */,-23 ),
	    /* State 11 */ new Array( 2/* "(" */,30 , 28/* "$" */,-26 , 18/* "," */,-26 , 11/* "<=" */,-26 , 12/* ">=" */,-26 , 13/* "==" */,-26 , 14/* "!=" */,-26 , 15/* "<" */,-26 , 16/* ">" */,-26 , 17/* "+" */,-26 , 19/* "-" */,-26 , 21/* "^" */,-26 , 22/* "||" */,-26 , 23/* "&&" */,-26 , 24/* "*" */,-26 , 25/* "/" */,-26 , 3/* ")" */,-26 ),
	    /* State 12 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 13 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 14 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 15 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 16 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 17 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 18 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 19 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 20 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 21 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 22 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 23 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 24 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 25 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 26 */ new Array( 25/* "/" */,-11 , 24/* "*" */,-11 , 23/* "&&" */,-11 , 22/* "||" */,-11 , 21/* "^" */,-11 , 19/* "-" */,-11 , 17/* "+" */,-11 , 16/* ">" */,-11 , 15/* "<" */,-11 , 14/* "!=" */,-11 , 13/* "==" */,-11 , 12/* ">=" */,-11 , 11/* "<=" */,-11 , 18/* "," */,-11 , 28/* "$" */,-11 , 3/* ")" */,-11 ),
	    /* State 27 */ new Array( 25/* "/" */,-17 , 24/* "*" */,-17 , 23/* "&&" */,-17 , 22/* "||" */,-17 , 21/* "^" */,-17 , 19/* "-" */,-17 , 17/* "+" */,-17 , 16/* ">" */,-17 , 15/* "<" */,-17 , 14/* "!=" */,-17 , 13/* "==" */,-17 , 12/* ">=" */,-17 , 11/* "<=" */,-17 , 18/* "," */,-17 , 28/* "$" */,-17 , 3/* ")" */,-17 ),
	    /* State 28 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,17 , 17/* "+" */,18 , 16/* ">" */,19 , 15/* "<" */,20 , 14/* "!=" */,21 , 13/* "==" */,22 , 12/* ">=" */,23 , 11/* "<=" */,24 , 18/* "," */,25 , 3/* ")" */,45 ),
	    /* State 29 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 30 */ new Array( 20/* "!" */,3 , 19/* "-" */,4 , 2/* "(" */,5 , 9/* "STRING" */,6 , 4/* "INT" */,7 , 5/* "FLOAT" */,8 , 6/* "PARAM" */,9 , 8/* "HTML" */,10 , 7/* "VAR" */,11 ),
	    /* State 31 */ new Array( 25/* "/" */,-16 , 24/* "*" */,-16 , 23/* "&&" */,-16 , 22/* "||" */,-16 , 21/* "^" */,-16 , 19/* "-" */,-16 , 17/* "+" */,-16 , 16/* ">" */,-16 , 15/* "<" */,-16 , 14/* "!=" */,-16 , 13/* "==" */,-16 , 12/* ">=" */,-16 , 11/* "<=" */,-16 , 18/* "," */,-16 , 28/* "$" */,-16 , 3/* ")" */,-16 ),
	    /* State 32 */ new Array( 25/* "/" */,-15 , 24/* "*" */,-15 , 23/* "&&" */,-15 , 22/* "||" */,-15 , 21/* "^" */,-15 , 19/* "-" */,-15 , 17/* "+" */,-15 , 16/* ">" */,-15 , 15/* "<" */,-15 , 14/* "!=" */,-15 , 13/* "==" */,-15 , 12/* ">=" */,-15 , 11/* "<=" */,-15 , 18/* "," */,-15 , 28/* "$" */,-15 , 3/* ")" */,-15 ),
	    /* State 33 */ new Array( 25/* "/" */,-14 , 24/* "*" */,-14 , 23/* "&&" */,-14 , 22/* "||" */,-14 , 21/* "^" */,-14 , 19/* "-" */,-14 , 17/* "+" */,-14 , 16/* ">" */,-14 , 15/* "<" */,-14 , 14/* "!=" */,-14 , 13/* "==" */,-14 , 12/* ">=" */,-14 , 11/* "<=" */,-14 , 18/* "," */,-14 , 28/* "$" */,-14 , 3/* ")" */,-14 ),
	    /* State 34 */ new Array( 25/* "/" */,-13 , 24/* "*" */,-13 , 23/* "&&" */,-13 , 22/* "||" */,-13 , 21/* "^" */,-13 , 19/* "-" */,-13 , 17/* "+" */,-13 , 16/* ">" */,-13 , 15/* "<" */,-13 , 14/* "!=" */,-13 , 13/* "==" */,-13 , 12/* ">=" */,-13 , 11/* "<=" */,-13 , 18/* "," */,-13 , 28/* "$" */,-13 , 3/* ")" */,-13 ),
	    /* State 35 */ new Array( 25/* "/" */,-12 , 24/* "*" */,-12 , 23/* "&&" */,-12 , 22/* "||" */,-12 , 21/* "^" */,-12 , 19/* "-" */,-12 , 17/* "+" */,-12 , 16/* ">" */,-12 , 15/* "<" */,-12 , 14/* "!=" */,-12 , 13/* "==" */,-12 , 12/* ">=" */,-12 , 11/* "<=" */,-12 , 18/* "," */,-12 , 28/* "$" */,-12 , 3/* ")" */,-12 ),
	    /* State 36 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-10 , 17/* "+" */,-10 , 16/* ">" */,-10 , 15/* "<" */,-10 , 14/* "!=" */,-10 , 13/* "==" */,-10 , 12/* ">=" */,-10 , 11/* "<=" */,-10 , 18/* "," */,-10 , 28/* "$" */,-10 , 3/* ")" */,-10 ),
	    /* State 37 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-9 , 17/* "+" */,-9 , 16/* ">" */,-9 , 15/* "<" */,-9 , 14/* "!=" */,-9 , 13/* "==" */,-9 , 12/* ">=" */,-9 , 11/* "<=" */,-9 , 18/* "," */,-9 , 28/* "$" */,-9 , 3/* ")" */,-9 ),
	    /* State 38 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-8 , 17/* "+" */,-8 , 16/* ">" */,-8 , 15/* "<" */,-8 , 14/* "!=" */,-8 , 13/* "==" */,-8 , 12/* ">=" */,-8 , 11/* "<=" */,-8 , 18/* "," */,-8 , 28/* "$" */,-8 , 3/* ")" */,-8 ),
	    /* State 39 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-7 , 17/* "+" */,-7 , 16/* ">" */,-7 , 15/* "<" */,-7 , 14/* "!=" */,-7 , 13/* "==" */,-7 , 12/* ">=" */,-7 , 11/* "<=" */,-7 , 18/* "," */,-7 , 28/* "$" */,-7 , 3/* ")" */,-7 ),
	    /* State 40 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-6 , 17/* "+" */,-6 , 16/* ">" */,-6 , 15/* "<" */,-6 , 14/* "!=" */,-6 , 13/* "==" */,-6 , 12/* ">=" */,-6 , 11/* "<=" */,-6 , 18/* "," */,-6 , 28/* "$" */,-6 , 3/* ")" */,-6 ),
	    /* State 41 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-5 , 17/* "+" */,-5 , 16/* ">" */,-5 , 15/* "<" */,-5 , 14/* "!=" */,-5 , 13/* "==" */,-5 , 12/* ">=" */,-5 , 11/* "<=" */,-5 , 18/* "," */,-5 , 28/* "$" */,-5 , 3/* ")" */,-5 ),
	    /* State 42 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-4 , 17/* "+" */,-4 , 16/* ">" */,-4 , 15/* "<" */,-4 , 14/* "!=" */,-4 , 13/* "==" */,-4 , 12/* ">=" */,-4 , 11/* "<=" */,-4 , 18/* "," */,-4 , 28/* "$" */,-4 , 3/* ")" */,-4 ),
	    /* State 43 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-3 , 17/* "+" */,-3 , 16/* ">" */,-3 , 15/* "<" */,-3 , 14/* "!=" */,-3 , 13/* "==" */,-3 , 12/* ">=" */,-3 , 11/* "<=" */,-3 , 18/* "," */,-3 , 28/* "$" */,-3 , 3/* ")" */,-3 ),
	    /* State 44 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-2 , 17/* "+" */,-2 , 16/* ">" */,-2 , 15/* "<" */,-2 , 14/* "!=" */,-2 , 13/* "==" */,-2 , 12/* ">=" */,-2 , 11/* "<=" */,-2 , 18/* "," */,-2 , 28/* "$" */,-2 , 3/* ")" */,-2 ),
	    /* State 45 */ new Array( 28/* "$" */,-18 , 18/* "," */,-18 , 11/* "<=" */,-18 , 12/* ">=" */,-18 , 13/* "==" */,-18 , 14/* "!=" */,-18 , 15/* "<" */,-18 , 16/* ">" */,-18 , 17/* "+" */,-18 , 19/* "-" */,-18 , 21/* "^" */,-18 , 22/* "||" */,-18 , 23/* "&&" */,-18 , 24/* "*" */,-18 , 25/* "/" */,-18 , 3/* ")" */,-18 ),
	    /* State 46 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,-19 , 17/* "+" */,-19 , 16/* ">" */,-19 , 15/* "<" */,-19 , 14/* "!=" */,-19 , 13/* "==" */,-19 , 12/* ">=" */,-19 , 11/* "<=" */,-19 , 18/* "," */,-19 , 28/* "$" */,-19 , 3/* ")" */,-19 ),
	    /* State 47 */ new Array( 25/* "/" */,12 , 24/* "*" */,13 , 23/* "&&" */,14 , 22/* "||" */,15 , 21/* "^" */,16 , 19/* "-" */,17 , 17/* "+" */,18 , 16/* ">" */,19 , 15/* "<" */,20 , 14/* "!=" */,21 , 13/* "==" */,22 , 12/* ">=" */,23 , 11/* "<=" */,24 , 18/* "," */,25 , 3/* ")" */,48 ),
	    /* State 48 */ new Array( 28/* "$" */,-25 , 18/* "," */,-25 , 11/* "<=" */,-25 , 12/* ">=" */,-25 , 13/* "==" */,-25 , 14/* "!=" */,-25 , 15/* "<" */,-25 , 16/* ">" */,-25 , 17/* "+" */,-25 , 19/* "-" */,-25 , 21/* "^" */,-25 , 22/* "||" */,-25 , 23/* "&&" */,-25 , 24/* "*" */,-25 , 25/* "/" */,-25 , 3/* ")" */,-25 )
	);
	...
	var goto_tab = new Array(
	    ...
	    /* State 10 */ new Array( ),
	    /* State 11 */ new Array( ),
	    /* State 12 */ new Array( 26/* e */,31 ),
	    /* State 13 */ new Array( 26/* e */,32 ),
	    /* State 14 */ new Array( 26/* e */,33 ),
	    /* State 15 */ new Array( 26/* e */,34 ),
	    /* State 16 */ new Array( 26/* e */,35 ),
	    /* State 17 */ new Array( 26/* e */,36 ),
	    /* State 18 */ new Array( 26/* e */,37 ),
	    /* State 19 */ new Array( 26/* e */,38 ),
	    /* State 20 */ new Array( 26/* e */,39 ),
	    /* State 21 */ new Array( 26/* e */,40 ),
	    /* State 22 */ new Array( 26/* e */,41 ),
	    /* State 23 */ new Array( 26/* e */,42 ),
	    /* State 24 */ new Array( 26/* e */,43 ),
	    /* State 25 */ new Array( 26/* e */,44 ),
	    /* State 26 */ new Array( ),
	    /* State 27 */ new Array( ),
	    /* State 28 */ new Array( ),
