...
Mat.ProbFuncs = {
  ...
  P: [
    ...
    5.26445194995477358631e2, 9.3452852717195760754e2, 1.02755188689515710272e3,
  ...
  Q1: [
    ...
    1.50425385692907503408e1, 2.50464946208309415979,
  ...
  ndtri: function (y0) {
    ...
    if (y > 0.13533528323661269189) {
      ...
      x =
        y +
        y * ((y2 * this.polevl(y2, this.P0, 4)) / this.p1evl(y2, this.Q0, 8));
      x = x * this.s2pi;
      return x;
    }
