...
Mat.Tiling = {
     ...
     *
     */
    triangulation: function (p1, p2, p3, p4, steps) {
        ...
        for (i = 1; i <= numRows; i++) {
            if (i % 2 === 0) {
                ...
                coords.push([
                    coords[oddPoints[0]][0] + steps * widthX,
                    coords[oddPoints[0]][1] + steps * widthY
                ]);
