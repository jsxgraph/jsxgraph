 ...
 * @param {Number} minor Every minor-th tick is drawn with height majorHeight, the other ones are drawn with height minorHeight.
 * @param {Number} majorHeight The height used to draw major ticks.
 * @param {Number} minorHeight The height used to draw minor ticks.
