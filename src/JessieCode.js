...
switch( state )
{
	case 0:
		...
		else if( info.src.charCodeAt( pos ) == 70 || info.src.charCodeAt( pos ) == 102 ) state = 71;
		else if( info.src.charCodeAt( pos ) == 87 || info.src.charCodeAt( pos ) == 119 ) state = 72;
	...
	case 44:
		...
		else if( ( info.src.charCodeAt( pos ) >= 0 && info.src.charCodeAt( pos ) <= 38 ) || ( info.src.charCodeAt( pos ) >= 40 && info.src.charCodeAt( pos ) <= 91 ) || ( info.src.charCodeAt( pos ) >= 93 && info.src.charCodeAt( pos ) <= 254 ) ) state = 45;
		else if( info.src.charCodeAt( pos ) == 92 ) state = 47;
		else state = -1;
		match = 39;
		match_pos = pos;
		break;
	...
	case 58:
		...
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 50;
		else state = -1;
		match = 38;
		match_pos = pos;
		break;
	...
	case 59:
		if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 82 ) || ( info.src.charCodeAt( pos ) >= 84 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 114 ) || ( info.src.charCodeAt( pos ) >= 116 && info.src.charCodeAt( pos ) <= 122 ) ) state = 3;
		else if( info.src.charCodeAt( pos ) == 83 || info.src.charCodeAt( pos ) == 115 ) state = 51;
		else state = -1;
		match = 38;
		match_pos = pos;
		break;
	...
	case 69:
		if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 84 ) || ( info.src.charCodeAt( pos ) >= 86 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 116 ) || ( info.src.charCodeAt( pos ) >= 118 && info.src.charCodeAt( pos ) <= 122 ) ) state = 3;
		else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 62;
		else state = -1;
		match = 38;
		match_pos = pos;
		break;
	...
	case 70:
		if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 72 ) || ( info.src.charCodeAt( pos ) >= 74 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 104 ) || ( info.src.charCodeAt( pos ) >= 106 && info.src.charCodeAt( pos ) <= 122 ) ) state = 3;
		else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 63;
		else state = -1;
		match = 38;
		match_pos = pos;
		break;
	...
	case 75:
		if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 83 ) || ( info.src.charCodeAt( pos ) >= 85 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 115 ) || ( info.src.charCodeAt( pos ) >= 117 && info.src.charCodeAt( pos ) <= 122 ) ) state = 3;
		else if( info.src.charCodeAt( pos ) == 84 || info.src.charCodeAt( pos ) == 116 ) state = 70;
		else state = -1;
		match = 38;
		match_pos = pos;
		break;
	...
	case 77:
		...
		else if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 75;
		else state = -1;
		match = 38;
		match_pos = pos;
		break;
...
var act_tab = new Array(
	...
	/* State 13 */ new Array( 37/* "." */,47 , 31/* "(" */,48 , 14/* "[" */,49 , 30/* "^" */,-45 , 18/* ";" */,-45 , 20/* "==" */,-45 , 25/* "<" */,-45 , 24/* ">" */,-45 , 22/* "<=" */,-45 , 23/* ">=" */,-45 , 21/* "!=" */,-45 , 27/* "-" */,-45 , 26/* "+" */,-45 , 29/* "*" */,-45 , 28/* "/" */,-45 ),
	/* State 14 */ new Array( 19/* "=" */,-28 , 37/* "." */,-53 , 14/* "[" */,-53 , 31/* "(" */,-53 , 30/* "^" */,-53 , 18/* ";" */,-53 , 20/* "==" */,-53 , 25/* "<" */,-53 , 24/* ">" */,-53 , 22/* "<=" */,-53 , 23/* ">=" */,-53 , 21/* "!=" */,-53 , 27/* "-" */,-53 , 26/* "+" */,-53 , 29/* "*" */,-53 , 28/* "/" */,-53 ),
	...
	/* State 16 */ new Array( 37/* "." */,-50 , 14/* "[" */,-50 , 31/* "(" */,-50 , 30/* "^" */,-50 , 18/* ";" */,-50 , 20/* "==" */,-50 , 25/* "<" */,-50 , 24/* ">" */,-50 , 22/* "<=" */,-50 , 23/* ">=" */,-50 , 21/* "!=" */,-50 , 27/* "-" */,-50 , 26/* "+" */,-50 , 29/* "*" */,-50 , 28/* "/" */,-50 , 2/* "IF" */,-50 , 4/* "WHILE" */,-50 , 5/* "DO" */,-50 , 7/* "USE" */,-50 , 9/* "DELETE" */,-50 , 8/* "RETURN" */,-50 , 16/* "{" */,-50 , 38/* "Identifier" */,-50 , 40/* "Integer" */,-50 , 41/* "Float" */,-50 , 39/* "String" */,-50 , 6/* "FUNCTION" */,-50 , 12/* "<<" */,-50 , 10/* "TRUE" */,-50 , 11/* "FALSE" */,-50 , 32/* ")" */,-50 , 15/* "]" */,-50 , 33/* "," */,-50 , 13/* ">>" */,-50 ),
	...
	/* State 18 */ new Array( 37/* "." */,-51 , 14/* "[" */,-51 , 31/* "(" */,-51 , 30/* "^" */,-51 , 18/* ";" */,-51 , 20/* "==" */,-51 , 25/* "<" */,-51 , 24/* ">" */,-51 , 22/* "<=" */,-51 , 23/* ">=" */,-51 , 21/* "!=" */,-51 , 27/* "-" */,-51 , 26/* "+" */,-51 , 29/* "*" */,-51 , 28/* "/" */,-51 , 2/* "IF" */,-51 , 4/* "WHILE" */,-51 , 5/* "DO" */,-51 , 7/* "USE" */,-51 , 9/* "DELETE" */,-51 , 8/* "RETURN" */,-51 , 16/* "{" */,-51 , 38/* "Identifier" */,-51 , 40/* "Integer" */,-51 , 41/* "Float" */,-51 , 39/* "String" */,-51 , 6/* "FUNCTION" */,-51 , 12/* "<<" */,-51 , 10/* "TRUE" */,-51 , 11/* "FALSE" */,-51 , 32/* ")" */,-51 , 15/* "]" */,-51 , 33/* "," */,-51 , 13/* ">>" */,-51 ),
	/* State 19 */ new Array( 37/* "." */,-52 , 14/* "[" */,-52 , 31/* "(" */,-52 , 30/* "^" */,-52 , 18/* ";" */,-52 , 20/* "==" */,-52 , 25/* "<" */,-52 , 24/* ">" */,-52 , 22/* "<=" */,-52 , 23/* ">=" */,-52 , 21/* "!=" */,-52 , 27/* "-" */,-52 , 26/* "+" */,-52 , 29/* "*" */,-52 , 28/* "/" */,-52 , 2/* "IF" */,-52 , 4/* "WHILE" */,-52 , 5/* "DO" */,-52 , 7/* "USE" */,-52 , 9/* "DELETE" */,-52 , 8/* "RETURN" */,-52 , 16/* "{" */,-52 , 38/* "Identifier" */,-52 , 40/* "Integer" */,-52 , 41/* "Float" */,-52 , 39/* "String" */,-52 , 6/* "FUNCTION" */,-52 , 12/* "<<" */,-52 , 10/* "TRUE" */,-52 , 11/* "FALSE" */,-52 , 32/* ")" */,-52 , 15/* "]" */,-52 , 33/* "," */,-52 , 13/* ">>" */,-52 ),
	...
	/* State 21 */ new Array( 37/* "." */,-55 , 14/* "[" */,-55 , 31/* "(" */,-55 , 30/* "^" */,-55 , 18/* ";" */,-55 , 20/* "==" */,-55 , 25/* "<" */,-55 , 24/* ">" */,-55 , 22/* "<=" */,-55 , 23/* ">=" */,-55 , 21/* "!=" */,-55 , 27/* "-" */,-55 , 26/* "+" */,-55 , 29/* "*" */,-55 , 28/* "/" */,-55 , 2/* "IF" */,-55 , 4/* "WHILE" */,-55 , 5/* "DO" */,-55 , 7/* "USE" */,-55 , 9/* "DELETE" */,-55 , 8/* "RETURN" */,-55 , 16/* "{" */,-55 , 38/* "Identifier" */,-55 , 40/* "Integer" */,-55 , 41/* "Float" */,-55 , 39/* "String" */,-55 , 6/* "FUNCTION" */,-55 , 12/* "<<" */,-55 , 10/* "TRUE" */,-55 , 11/* "FALSE" */,-55 , 32/* ")" */,-55 , 15/* "]" */,-55 , 33/* "," */,-55 , 13/* ">>" */,-55 ),
	...
	/* State 25 */ new Array( 37/* "." */,-59 , 14/* "[" */,-59 , 31/* "(" */,-59 , 30/* "^" */,-59 , 18/* ";" */,-59 , 20/* "==" */,-59 , 25/* "<" */,-59 , 24/* ">" */,-59 , 22/* "<=" */,-59 , 23/* ">=" */,-59 , 21/* "!=" */,-59 , 27/* "-" */,-59 , 26/* "+" */,-59 , 29/* "*" */,-59 , 28/* "/" */,-59 , 2/* "IF" */,-59 , 4/* "WHILE" */,-59 , 5/* "DO" */,-59 , 7/* "USE" */,-59 , 9/* "DELETE" */,-59 , 8/* "RETURN" */,-59 , 16/* "{" */,-59 , 38/* "Identifier" */,-59 , 40/* "Integer" */,-59 , 41/* "Float" */,-59 , 39/* "String" */,-59 , 6/* "FUNCTION" */,-59 , 12/* "<<" */,-59 , 10/* "TRUE" */,-59 , 11/* "FALSE" */,-59 , 32/* ")" */,-59 , 15/* "]" */,-59 , 33/* "," */,-59 , 13/* ">>" */,-59 ),
	/* State 26 */ new Array( 37/* "." */,-60 , 14/* "[" */,-60 , 31/* "(" */,-60 , 30/* "^" */,-60 , 18/* ";" */,-60 , 20/* "==" */,-60 , 25/* "<" */,-60 , 24/* ">" */,-60 , 22/* "<=" */,-60 , 23/* ">=" */,-60 , 21/* "!=" */,-60 , 27/* "-" */,-60 , 26/* "+" */,-60 , 29/* "*" */,-60 , 28/* "/" */,-60 , 2/* "IF" */,-60 , 4/* "WHILE" */,-60 , 5/* "DO" */,-60 , 7/* "USE" */,-60 , 9/* "DELETE" */,-60 , 8/* "RETURN" */,-60 , 16/* "{" */,-60 , 38/* "Identifier" */,-60 , 40/* "Integer" */,-60 , 41/* "Float" */,-60 , 39/* "String" */,-60 , 6/* "FUNCTION" */,-60 , 12/* "<<" */,-60 , 10/* "TRUE" */,-60 , 11/* "FALSE" */,-60 , 32/* ")" */,-60 , 15/* "]" */,-60 , 33/* "," */,-60 , 13/* ">>" */,-60 ),
	/* State 27 */ new Array( 18/* ";" */,-41 , 20/* "==" */,-41 , 25/* "<" */,-41 , 24/* ">" */,-41 , 22/* "<=" */,-41 , 23/* ">=" */,-41 , 21/* "!=" */,-41 , 27/* "-" */,-41 , 26/* "+" */,-41 , 29/* "*" */,-41 , 28/* "/" */,-41 , 2/* "IF" */,-41 , 4/* "WHILE" */,-41 , 5/* "DO" */,-41 , 7/* "USE" */,-41 , 9/* "DELETE" */,-41 , 8/* "RETURN" */,-41 , 16/* "{" */,-41 , 38/* "Identifier" */,-41 , 40/* "Integer" */,-41 , 41/* "Float" */,-41 , 31/* "(" */,-41 , 39/* "String" */,-41 , 6/* "FUNCTION" */,-41 , 12/* "<<" */,-41 , 14/* "[" */,-41 , 10/* "TRUE" */,-41 , 11/* "FALSE" */,-41 , 32/* ")" */,-41 , 15/* "]" */,-41 , 33/* "," */,-41 , 13/* ">>" */,-41 ),
	/* State 28 */ new Array( 30/* "^" */,61 , 18/* ";" */,-43 , 20/* "==" */,-43 , 25/* "<" */,-43 , 24/* ">" */,-43 , 22/* "<=" */,-43 , 23/* ">=" */,-43 , 21/* "!=" */,-43 , 27/* "-" */,-43 , 26/* "+" */,-43 , 29/* "*" */,-43 , 28/* "/" */,-43 , 2/* "IF" */,-43 , 4/* "WHILE" */,-43 , 5/* "DO" */,-43 , 7/* "USE" */,-43 , 9/* "DELETE" */,-43 , 8/* "RETURN" */,-43 , 16/* "{" */,-43 , 38/* "Identifier" */,-43 , 40/* "Integer" */,-43 , 41/* "Float" */,-43 , 31/* "(" */,-43 , 39/* "String" */,-43 , 6/* "FUNCTION" */,-43 , 12/* "<<" */,-43 , 14/* "[" */,-43 , 10/* "TRUE" */,-43 , 11/* "FALSE" */,-43 , 32/* ")" */,-43 , 15/* "]" */,-43 , 33/* "," */,-43 , 13/* ">>" */,-43 ),
	...
	/* State 31 */ new Array( 37/* "." */,64 , 31/* "(" */,48 , 14/* "[" */,65 , 30/* "^" */,-45 , 2/* "IF" */,-45 , 4/* "WHILE" */,-45 , 5/* "DO" */,-45 , 7/* "USE" */,-45 , 9/* "DELETE" */,-45 , 8/* "RETURN" */,-45 , 16/* "{" */,-45 , 18/* ";" */,-45 , 38/* "Identifier" */,-45 , 40/* "Integer" */,-45 , 41/* "Float" */,-45 , 39/* "String" */,-45 , 6/* "FUNCTION" */,-45 , 12/* "<<" */,-45 , 10/* "TRUE" */,-45 , 11/* "FALSE" */,-45 , 27/* "-" */,-45 , 20/* "==" */,-45 , 25/* "<" */,-45 , 24/* ">" */,-45 , 22/* "<=" */,-45 , 23/* ">=" */,-45 , 21/* "!=" */,-45 , 26/* "+" */,-45 , 29/* "*" */,-45 , 28/* "/" */,-45 , 32/* ")" */,-45 , 15/* "]" */,-45 , 33/* "," */,-45 , 13/* ">>" */,-45 ),
	/* State 32 */ new Array( 30/* "^" */,-53 , 2/* "IF" */,-53 , 4/* "WHILE" */,-53 , 5/* "DO" */,-53 , 7/* "USE" */,-53 , 9/* "DELETE" */,-53 , 8/* "RETURN" */,-53 , 16/* "{" */,-53 , 18/* ";" */,-53 , 38/* "Identifier" */,-53 , 40/* "Integer" */,-53 , 41/* "Float" */,-53 , 31/* "(" */,-53 , 39/* "String" */,-53 , 6/* "FUNCTION" */,-53 , 12/* "<<" */,-53 , 14/* "[" */,-53 , 10/* "TRUE" */,-53 , 11/* "FALSE" */,-53 , 27/* "-" */,-53 , 20/* "==" */,-53 , 25/* "<" */,-53 , 24/* ">" */,-53 , 22/* "<=" */,-53 , 23/* ">=" */,-53 , 21/* "!=" */,-53 , 26/* "+" */,-53 , 29/* "*" */,-53 , 28/* "/" */,-53 , 37/* "." */,-53 , 32/* ")" */,-53 , 15/* "]" */,-53 , 33/* "," */,-53 , 13/* ">>" */,-53 ),
	...
	/* State 62 */ new Array( 37/* "." */,64 , 31/* "(" */,48 , 14/* "[" */,65 , 30/* "^" */,-44 , 18/* ";" */,-44 , 20/* "==" */,-44 , 25/* "<" */,-44 , 24/* ">" */,-44 , 22/* "<=" */,-44 , 23/* ">=" */,-44 , 21/* "!=" */,-44 , 27/* "-" */,-44 , 26/* "+" */,-44 , 29/* "*" */,-44 , 28/* "/" */,-44 , 2/* "IF" */,-44 , 4/* "WHILE" */,-44 , 5/* "DO" */,-44 , 7/* "USE" */,-44 , 9/* "DELETE" */,-44 , 8/* "RETURN" */,-44 , 16/* "{" */,-44 , 38/* "Identifier" */,-44 , 40/* "Integer" */,-44 , 41/* "Float" */,-44 , 39/* "String" */,-44 , 6/* "FUNCTION" */,-44 , 12/* "<<" */,-44 , 10/* "TRUE" */,-44 , 11/* "FALSE" */,-44 , 32/* ")" */,-44 , 15/* "]" */,-44 , 33/* "," */,-44 , 13/* ">>" */,-44 ),
	...
	/* State 78 */ new Array( 19/* "=" */,-26 , 37/* "." */,-49 , 14/* "[" */,-49 , 31/* "(" */,-49 , 30/* "^" */,-49 , 18/* ";" */,-49 , 20/* "==" */,-49 , 25/* "<" */,-49 , 24/* ">" */,-49 , 22/* "<=" */,-49 , 23/* ">=" */,-49 , 21/* "!=" */,-49 , 27/* "-" */,-49 , 26/* "+" */,-49 , 29/* "*" */,-49 , 28/* "/" */,-49 ),
	...
	/* State 83 */ new Array( 18/* ";" */,-40 , 20/* "==" */,-40 , 25/* "<" */,-40 , 24/* ">" */,-40 , 22/* "<=" */,-40 , 23/* ">=" */,-40 , 21/* "!=" */,-40 , 27/* "-" */,-40 , 26/* "+" */,-40 , 29/* "*" */,-40 , 28/* "/" */,-40 , 2/* "IF" */,-40 , 4/* "WHILE" */,-40 , 5/* "DO" */,-40 , 7/* "USE" */,-40 , 9/* "DELETE" */,-40 , 8/* "RETURN" */,-40 , 16/* "{" */,-40 , 38/* "Identifier" */,-40 , 40/* "Integer" */,-40 , 41/* "Float" */,-40 , 31/* "(" */,-40 , 39/* "String" */,-40 , 6/* "FUNCTION" */,-40 , 12/* "<<" */,-40 , 14/* "[" */,-40 , 10/* "TRUE" */,-40 , 11/* "FALSE" */,-40 , 32/* ")" */,-40 , 15/* "]" */,-40 , 33/* "," */,-40 , 13/* ">>" */,-40 ),
	/* State 84 */ new Array( 18/* ";" */,-39 , 20/* "==" */,-39 , 25/* "<" */,-39 , 24/* ">" */,-39 , 22/* "<=" */,-39 , 23/* ">=" */,-39 , 21/* "!=" */,-39 , 27/* "-" */,-39 , 26/* "+" */,-39 , 29/* "*" */,-39 , 28/* "/" */,-39 , 2/* "IF" */,-39 , 4/* "WHILE" */,-39 , 5/* "DO" */,-39 , 7/* "USE" */,-39 , 9/* "DELETE" */,-39 , 8/* "RETURN" */,-39 , 16/* "{" */,-39 , 38/* "Identifier" */,-39 , 40/* "Integer" */,-39 , 41/* "Float" */,-39 , 31/* "(" */,-39 , 39/* "String" */,-39 , 6/* "FUNCTION" */,-39 , 12/* "<<" */,-39 , 14/* "[" */,-39 , 10/* "TRUE" */,-39 , 11/* "FALSE" */,-39 , 32/* ")" */,-39 , 15/* "]" */,-39 , 33/* "," */,-39 , 13/* ">>" */,-39 ),
	/* State 85 */ new Array( 37/* "." */,-54 , 14/* "[" */,-54 , 31/* "(" */,-54 , 30/* "^" */,-54 , 18/* ";" */,-54 , 20/* "==" */,-54 , 25/* "<" */,-54 , 24/* ">" */,-54 , 22/* "<=" */,-54 , 23/* ">=" */,-54 , 21/* "!=" */,-54 , 27/* "-" */,-54 , 26/* "+" */,-54 , 29/* "*" */,-54 , 28/* "/" */,-54 , 2/* "IF" */,-54 , 4/* "WHILE" */,-54 , 5/* "DO" */,-54 , 7/* "USE" */,-54 , 9/* "DELETE" */,-54 , 8/* "RETURN" */,-54 , 16/* "{" */,-54 , 38/* "Identifier" */,-54 , 40/* "Integer" */,-54 , 41/* "Float" */,-54 , 39/* "String" */,-54 , 6/* "FUNCTION" */,-54 , 12/* "<<" */,-54 , 10/* "TRUE" */,-54 , 11/* "FALSE" */,-54 , 32/* ")" */,-54 , 15/* "]" */,-54 , 33/* "," */,-54 , 13/* ">>" */,-54 ),
	/* State 86 */ new Array( 33/* "," */,101 , 32/* ")" */,102 ),
	/* State 87 */ new Array( 32/* ")" */,-13 , 33/* "," */,-13 ),
	/* State 88 */ new Array( 38/* "Identifier" */,58 ),
	/* State 89 */ new Array( 37/* "." */,-57 , 14/* "[" */,-57 , 31/* "(" */,-57 , 30/* "^" */,-57 , 18/* ";" */,-57 , 20/* "==" */,-57 , 25/* "<" */,-57 , 24/* ">" */,-57 , 22/* "<=" */,-57 , 23/* ">=" */,-57 , 21/* "!=" */,-57 , 27/* "-" */,-57 , 26/* "+" */,-57 , 29/* "*" */,-57 , 28/* "/" */,-57 , 2/* "IF" */,-57 , 4/* "WHILE" */,-57 , 5/* "DO" */,-57 , 7/* "USE" */,-57 , 9/* "DELETE" */,-57 , 8/* "RETURN" */,-57 , 16/* "{" */,-57 , 38/* "Identifier" */,-57 , 40/* "Integer" */,-57 , 41/* "Float" */,-57 , 39/* "String" */,-57 , 6/* "FUNCTION" */,-57 , 12/* "<<" */,-57 , 10/* "TRUE" */,-57 , 11/* "FALSE" */,-57 , 32/* ")" */,-57 , 15/* "]" */,-57 , 33/* "," */,-57 , 13/* ">>" */,-57 ),
	...
	/* State 92 */ new Array( 37/* "." */,-58 , 14/* "[" */,-58 , 31/* "(" */,-58 , 30/* "^" */,-58 , 18/* ";" */,-58 , 20/* "==" */,-58 , 25/* "<" */,-58 , 24/* ">" */,-58 , 22/* "<=" */,-58 , 23/* ">=" */,-58 , 21/* "!=" */,-58 , 27/* "-" */,-58 , 26/* "+" */,-58 , 29/* "*" */,-58 , 28/* "/" */,-58 , 2/* "IF" */,-58 , 4/* "WHILE" */,-58 , 5/* "DO" */,-58 , 7/* "USE" */,-58 , 9/* "DELETE" */,-58 , 8/* "RETURN" */,-58 , 16/* "{" */,-58 , 38/* "Identifier" */,-58 , 40/* "Integer" */,-58 , 41/* "Float" */,-58 , 39/* "String" */,-58 , 6/* "FUNCTION" */,-58 , 12/* "<<" */,-58 , 10/* "TRUE" */,-58 , 11/* "FALSE" */,-58 , 32/* ")" */,-58 , 15/* "]" */,-58 , 33/* "," */,-58 , 13/* ">>" */,-58 ),
	/* State 93 */ new Array( 18/* ";" */,-42 , 20/* "==" */,-42 , 25/* "<" */,-42 , 24/* ">" */,-42 , 22/* "<=" */,-42 , 23/* ">=" */,-42 , 21/* "!=" */,-42 , 27/* "-" */,-42 , 26/* "+" */,-42 , 29/* "*" */,-42 , 28/* "/" */,-42 , 2/* "IF" */,-42 , 4/* "WHILE" */,-42 , 5/* "DO" */,-42 , 7/* "USE" */,-42 , 9/* "DELETE" */,-42 , 8/* "RETURN" */,-42 , 16/* "{" */,-42 , 38/* "Identifier" */,-42 , 40/* "Integer" */,-42 , 41/* "Float" */,-42 , 31/* "(" */,-42 , 39/* "String" */,-42 , 6/* "FUNCTION" */,-42 , 12/* "<<" */,-42 , 14/* "[" */,-42 , 10/* "TRUE" */,-42 , 11/* "FALSE" */,-42 , 32/* ")" */,-42 , 15/* "]" */,-42 , 33/* "," */,-42 , 13/* ">>" */,-42 ),
	...
	/* State 95 */ new Array( 30/* "^" */,-49 , 2/* "IF" */,-49 , 4/* "WHILE" */,-49 , 5/* "DO" */,-49 , 7/* "USE" */,-49 , 9/* "DELETE" */,-49 , 8/* "RETURN" */,-49 , 16/* "{" */,-49 , 18/* ";" */,-49 , 38/* "Identifier" */,-49 , 40/* "Integer" */,-49 , 41/* "Float" */,-49 , 31/* "(" */,-49 , 39/* "String" */,-49 , 6/* "FUNCTION" */,-49 , 12/* "<<" */,-49 , 14/* "[" */,-49 , 10/* "TRUE" */,-49 , 11/* "FALSE" */,-49 , 27/* "-" */,-49 , 20/* "==" */,-49 , 25/* "<" */,-49 , 24/* ">" */,-49 , 22/* "<=" */,-49 , 23/* ">=" */,-49 , 21/* "!=" */,-49 , 26/* "+" */,-49 , 29/* "*" */,-49 , 28/* "/" */,-49 , 37/* "." */,-49 , 32/* ")" */,-49 , 15/* "]" */,-49 , 33/* "," */,-49 , 13/* ">>" */,-49 ),
	...
	/* State 99 */ new Array( 12/* "<<" */,109 , 37/* "." */,-47 , 14/* "[" */,-47 , 31/* "(" */,-47 , 30/* "^" */,-47 , 18/* ";" */,-47 , 20/* "==" */,-47 , 25/* "<" */,-47 , 24/* ">" */,-47 , 22/* "<=" */,-47 , 23/* ">=" */,-47 , 21/* "!=" */,-47 , 27/* "-" */,-47 , 26/* "+" */,-47 , 29/* "*" */,-47 , 28/* "/" */,-47 , 2/* "IF" */,-47 , 4/* "WHILE" */,-47 , 5/* "DO" */,-47 , 7/* "USE" */,-47 , 9/* "DELETE" */,-47 , 8/* "RETURN" */,-47 , 16/* "{" */,-47 , 38/* "Identifier" */,-47 , 40/* "Integer" */,-47 , 41/* "Float" */,-47 , 39/* "String" */,-47 , 6/* "FUNCTION" */,-47 , 10/* "TRUE" */,-47 , 11/* "FALSE" */,-47 , 32/* ")" */,-47 , 15/* "]" */,-47 , 33/* "," */,-47 , 13/* ">>" */,-47 ),
	/* State 100 */ new Array( 37/* "." */,-46 , 14/* "[" */,-46 , 31/* "(" */,-46 , 30/* "^" */,-46 , 18/* ";" */,-46 , 20/* "==" */,-46 , 25/* "<" */,-46 , 24/* ">" */,-46 , 22/* "<=" */,-46 , 23/* ">=" */,-46 , 21/* "!=" */,-46 , 27/* "-" */,-46 , 26/* "+" */,-46 , 29/* "*" */,-46 , 28/* "/" */,-46 , 19/* "=" */,-27 ),
	...
	/* State 107 */ new Array( 30/* "^" */,-46 , 2/* "IF" */,-46 , 4/* "WHILE" */,-46 , 5/* "DO" */,-46 , 7/* "USE" */,-46 , 9/* "DELETE" */,-46 , 8/* "RETURN" */,-46 , 16/* "{" */,-46 , 18/* ";" */,-46 , 38/* "Identifier" */,-46 , 40/* "Integer" */,-46 , 41/* "Float" */,-46 , 31/* "(" */,-46 , 39/* "String" */,-46 , 6/* "FUNCTION" */,-46 , 12/* "<<" */,-46 , 14/* "[" */,-46 , 10/* "TRUE" */,-46 , 11/* "FALSE" */,-46 , 27/* "-" */,-46 , 20/* "==" */,-46 , 25/* "<" */,-46 , 24/* ">" */,-46 , 22/* "<=" */,-46 , 23/* ">=" */,-46 , 21/* "!=" */,-46 , 26/* "+" */,-46 , 29/* "*" */,-46 , 28/* "/" */,-46 , 37/* "." */,-46 , 32/* ")" */,-46 , 15/* "]" */,-46 , 33/* "," */,-46 , 13/* ">>" */,-46 ),
	...
	/* State 114 */ new Array( 37/* "." */,-48 , 14/* "[" */,-48 , 31/* "(" */,-48 , 30/* "^" */,-48 , 18/* ";" */,-48 , 20/* "==" */,-48 , 25/* "<" */,-48 , 24/* ">" */,-48 , 22/* "<=" */,-48 , 23/* ">=" */,-48 , 21/* "!=" */,-48 , 27/* "-" */,-48 , 26/* "+" */,-48 , 29/* "*" */,-48 , 28/* "/" */,-48 , 2/* "IF" */,-48 , 4/* "WHILE" */,-48 , 5/* "DO" */,-48 , 7/* "USE" */,-48 , 9/* "DELETE" */,-48 , 8/* "RETURN" */,-48 , 16/* "{" */,-48 , 38/* "Identifier" */,-48 , 40/* "Integer" */,-48 , 41/* "Float" */,-48 , 39/* "String" */,-48 , 6/* "FUNCTION" */,-48 , 12/* "<<" */,-48 , 10/* "TRUE" */,-48 , 11/* "FALSE" */,-48 , 32/* ")" */,-48 , 15/* "]" */,-48 , 33/* "," */,-48 , 13/* ">>" */,-48 ),
	/* State 115 */ new Array( 37/* "." */,-56 , 14/* "[" */,-56 , 31/* "(" */,-56 , 30/* "^" */,-56 , 18/* ";" */,-56 , 20/* "==" */,-56 , 25/* "<" */,-56 , 24/* ">" */,-56 , 22/* "<=" */,-56 , 23/* ">=" */,-56 , 21/* "!=" */,-56 , 27/* "-" */,-56 , 26/* "+" */,-56 , 29/* "*" */,-56 , 28/* "/" */,-56 , 2/* "IF" */,-56 , 4/* "WHILE" */,-56 , 5/* "DO" */,-56 , 7/* "USE" */,-56 , 9/* "DELETE" */,-56 , 8/* "RETURN" */,-56 , 16/* "{" */,-56 , 38/* "Identifier" */,-56 , 40/* "Integer" */,-56 , 41/* "Float" */,-56 , 39/* "String" */,-56 , 6/* "FUNCTION" */,-56 , 12/* "<<" */,-56 , 10/* "TRUE" */,-56 , 11/* "FALSE" */,-56 , 32/* ")" */,-56 , 15/* "]" */,-56 , 33/* "," */,-56 , 13/* ">>" */,-56 )
);
...
var goto_tab = new Array(
	...
	/* State 59 */ new Array(  ),
	/* State 60 */ new Array(  ),
	/* State 61 */ new Array( 54/* ExpExp */,93 , 55/* NegExp */,28 , 51/* ExtValue */,31 , 56/* Value */,16 ),
	/* State 62 */ new Array(  ),
	/* State 63 */ new Array(  ),
	/* State 64 */ new Array(  ),
