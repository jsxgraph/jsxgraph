...
define(["jxg", "base/constants"], function (JXG, Const) {
  "use strict";
    ...
    /** @lends JXG */ {
      ...
      copyPrototypeMethods: function (subObject, superObject, constructorName) {
        ...
        subObject.prototype[constructorName] =
          superObject.prototype.constructor;
          ...
          if (typeof filter === "object") {
            for (f in filter) {
              if (filter.hasOwnProperty(f)) {
                ...
                if (
                  item.visProp &&
                  typeof item.visProp[flower] === "function"
                ) {
      ...
      evalSlider: function (s) {
        if (
          s &&
          s.type === Const.OBJECT_TYPE_GLIDER &&
