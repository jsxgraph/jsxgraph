    ...
    /** @lends JXG.GeometryElement.prototype */ {
      ...
      setPosition: function (method, coords) {
        ...
        if (len > 0) {
          ...
          if (
            ...
            this.transformations[this.transformations.length - 1]
              .isNumericMatrix
          ) {
      ...
      setDisplayRendNode: function (val) {
        ...
        if (
          ...
          Type.exists(this.label.rendNode)
        ) {
      ...
      highlight: function (force) {
        ...
        if (
          Type.evaluate(this.visProp.highlight) &&
      ...
      handleSnapToGrid: function (force, fromParent) {
        ...
        needsSnapToGrid =
          Type.evaluate(this.visProp.snaptogrid) ||
          attractToGrid ||
          force === true;
