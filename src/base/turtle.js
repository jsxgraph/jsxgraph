...
define(["jxg", "base/constants", "base/element", "utils/type"], function (
  JXG,
  Const,
  GeometryElement,
  Type
  ...
  JXG.Turtle = function (board, parents, attributes) {
    ...
    this._attributes = Type.copyAttributes(
      this.visProp,
      board.options,
      "turtle"
    );
    ...
    /** @lends JXG.Turtle.prototype */ {
      ...
      setPos: function (x, y) {
        ...
        if (!this.turtleIsHidden) {
          ...
          this.turtle2.setPositionDirectly(Const.COORDS_BY_USER, [
            x,
            y + this.arrowLen,
          ]);
          t = this.board.create(
