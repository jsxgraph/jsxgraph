    ...
    /** @lends JXG.JessieCode.prototype */ {
          ...
          case "node_op":
            switch (node.value) {
              ...
              case "op_prop":
                ...
                // child 1: Value
                ret =
                  node.children[0] + ": " + this.compile(node.children[1], js);
                break;
              case "op_emptyobject":
                ret = js ? "{}" : "<< >>";
                break;
      ...
      use: function (board) {
        ...
        if (typeof board === "string") {
          ...
          for (b in JXG.boards) {
            if (
              JXG.boards.hasOwnProperty(b) &&
              JXG.boards[b].container === board
            ) {
              ref = JXG.boards[b];
              found = true;
              break;
...
*/
  var parser = (function () {
    var o = function (k, v, o, l) {
      ...
      $Vp = [1, 39],
      $Vq = [
        5, 7, 8, 14, 15, 16, 17, 19, 20, 21, 23, 26, 27, 50, 51, 58, 65, 74, 75,
        76, 77, 78, 79, 80, 82, 91, 93,
      ],
      $Vr = [
        5, 7, 8, 12, 14, 15, 16, 17, 19, 20, 21, 23, 26, 27, 50, 51, 58, 65, 74,
        75, 76, 77, 78, 79, 80, 82, 91, 93,
      ],
      $Vs = [
        8, 10, 16, 32, 34, 35, 37, 39, 41, 42, 43, 45, 46, 47, 48, 50, 51, 53,
        54, 55, 57, 64, 65, 66, 83, 86,
      ],
      $Vt = [2, 48],
      $Vu = [1, 72],
      $Vv = [
        10, 16, 32, 34, 35, 37, 39, 41, 42, 43, 45, 46, 47, 48, 50, 51, 53, 54,
        55, 57, 66, 83, 86,
      ],
      $Vw = [1, 78],
      $Vx = [
        8, 10, 16, 32, 34, 35, 37, 41, 42, 43, 45, 46, 47, 48, 50, 51, 53, 54,
        55, 57, 64, 65, 66, 83, 86,
      ],
      $Vy = [1, 82],
      $Vz = [
        8, 10, 16, 32, 34, 35, 37, 39, 45, 46, 47, 48, 50, 51, 53, 54, 55, 57,
        64, 65, 66, 83, 86,
      ],
      $VA = [1, 83],
      $VB = [1, 84],
      $VC = [1, 85],
      $VD = [
        8, 10, 16, 32, 34, 35, 37, 39, 41, 42, 43, 50, 51, 53, 54, 55, 57, 64,
        65, 66, 83, 86,
      ],
      $VE = [1, 89],
      $VF = [1, 90],
      ...
      $VI = [1, 97],
      $VJ = [
        8, 10, 16, 32, 34, 35, 37, 39, 41, 42, 43, 45, 46, 47, 48, 53, 54, 55,
        57, 64, 65, 66, 83, 86,
      ],
      $VK = [1, 103],
      $VL = [1, 104],
      $VM = [
        8, 10, 16, 32, 34, 35, 37, 39, 41, 42, 43, 45, 46, 47, 48, 50, 51, 57,
        64, 65, 66, 83, 86,
      ],
      $VN = [1, 105],
      $VO = [1, 106],
      ...
      $VU = [10, 66, 86],
      $VV = [
        8, 10, 16, 20, 32, 34, 35, 37, 39, 41, 42, 43, 45, 46, 47, 48, 50, 51,
        53, 54, 55, 57, 64, 65, 66, 82, 83, 86,
      ],
      $VW = [1, 167],
      $VX = [10, 86];
    var parser = {
      ...
      table: [
        o(
          [
            5, 7, 8, 14, 15, 16, 17, 19, 20, 21, 23, 26, 50, 51, 58, 65, 74, 75,
            76, 77, 78, 79, 80, 82, 91, 93,
          ],
          $V0,
          { 3: 1, 4: 2 }
        ...
        o(
          [
            7, 8, 14, 15, 16, 17, 19, 20, 21, 23, 26, 27, 50, 51, 58, 65, 74,
            75, 76, 77, 78, 79, 80, 82, 91, 93,
          ],
          $V0,
          { 4: 61 }
        ...
        o(
          [
            8, 10, 16, 34, 35, 37, 39, 41, 42, 43, 45, 46, 47, 48, 50, 51, 53,
            54, 55, 64, 65, 66, 83, 86,
          ],
          $Vt,
          { 32: [1, 71], 57: $Vu }
        ),
        o(
          [
            8, 10, 16, 32, 35, 39, 41, 42, 43, 45, 46, 47, 48, 50, 51, 53, 54,
            55, 57, 64, 65, 66, 83, 86,
          ],
          [2, 26],
          { 34: [1, 73], 37: [1, 74] }
        ...
        o(
          [
            8, 10, 16, 32, 34, 35, 37, 39, 41, 42, 43, 45, 46, 47, 48, 50, 51,
            53, 54, 55, 64, 65, 66, 83, 86,
          ],
          $Vt,
          { 57: $Vu }
        ),
        ...
        o(
          [
            5, 7, 8, 10, 12, 14, 15, 16, 17, 19, 20, 21, 23, 26, 27, 32, 34, 35,
            37, 39, 41, 42, 43, 45, 46, 47, 48, 50, 51, 53, 54, 55, 57, 58, 64,
            65, 66, 74, 75, 76, 77, 78, 79, 80, 82, 83, 86, 91, 93,
          ],
          [2, 12]
        ),
        { 10: [1, 156] },
