...
define([
  ...
  JXG.VMLRenderer = function (container) {
    ...
    if (!Type.exists(JXG.vmlStylesheet)) {
      container.ownerDocument.namespaces.add(
        "jxgvml",
    ...
    /** @lends JXG.VMLRenderer.prototype */ {
      ...
      updateTicks: function (ticks) {
        ...
        if (!Type.exists(ticks.rendNode)) {
          ...
          this.appendChildPrim(
            ticks.rendNode,
            Type.evaluate(ticks.visProp.layer)
          );
        }
      ...
      createPrim: function (type, id) {
        ...
        this._setAttr(
          strokeNode,
          "id",
          this.container.id + "_" + id + "_stroke"
        );
        this._setAttr(
          shadowNode,
          "id",
          this.container.id + "_" + id + "_shadow"
        );
      ...
      makeArrows: function (el) {
        ...
        if (ev_la) {
          ...
          this._setAttr(
            nodeStroke,
            "id",
            this.container.id + "_" + el.id + "stroke"
          );
