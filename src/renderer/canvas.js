    ...
    /** @lends JXG.CanvasRenderer.prototype */ {
      ...
      updateGradient: function (el) {
        ...
        gradient.addColorStop(
          Type.evaluate(el.visProp.gradientstartoffset),
          col
        );
        gradient.addColorStop(
      ...
      drawArrows: function (el, scr1, scr2, hl, a) {
        ...
        if (
          Type.evaluate(el.visProp.strokecolor) !== "none" &&
          (ev_fa || ev_la)
        ) {
          if (el.elementClass === Const.OBJECT_CLASS_LINE) {
            ...
            d2x =
              el.points[last].scrCoords[1] - el.points[last - 1].scrCoords[1];
            d2y =
              el.points[last].scrCoords[2] - el.points[last - 1].scrCoords[2];
            if (ev_fa) {
          ...
          if (this._setColor(el, "stroke", "fill")) {
            ...
            if (ev_fa) {
              ...
              this._drawPolygon(
                this._translateShape(
                  this._rotateShape(arrowTail, ang1),
                  x1,
                  y1
                ),
                degree_fa,
            ...
            if (ev_la) {
              ...
              this._drawPolygon(
                this._translateShape(
                  this._rotateShape(arrowHead, ang2),
                  x2,
                  y2
                ),
                degree_la,
