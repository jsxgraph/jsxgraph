...
var to_x=0,to_y=0, scale_x=0, scale_y=0, rot_a=0,rot_x=0,rot_y=0;
...
// Result class
//
function Result(name, score, to_x, to_y, scale_x, scale_y, rot_a, rot_x, rot_y) // constructor
{
	this.Name = name;
	this.Score = score;
	this.To_x = to_x;
...
var HalfDiagonal = 0.5 * Math.sqrt(250.0 * 250.0 + 250.0 * 250.0);
var AngleRange = 45.0;
var AnglePrecision = 2.0;
...
function Recognizer() // constructor
{
	...
	this.Templates[0] = new Template("line", points_opt_line)
	...
	this.Templates[1] = new Template("circle", points_opt_circle);
	//this.Templates[1] = new Template("circle", new Array(new Point(127,141),new Point(124,140),new Point(120,139),new Point(118,139),new Point(116,139),new Point(111,140),new Point(109,141),new Point(104,144),new Point(100,147),new Point(96,152),new Point(93,157),new Point(90,163),new Point(87,169),new Point(85,175),new Point(83,181),new Point(82,190),new Point(82,195),new Point(83,200),new Point(84,205),new Point(88,213),new Point(91,216),new Point(96,219),new Point(103,222),new Point(108,224),new Point(111,224),new Point(120,224),new Point(133,223),new Point(142,222),new Point(152,218),new Point(160,214),new Point(167,210),new Point(173,204),new Point(178,198),new Point(179,196),new Point(182,188),new Point(182,177),new Point(178,167),new Point(170,150),new Point(163,138),new Point(152,130),new Point(143,129),new Point(140,131),new Point(129,136),new Point(126,139)));
	...
	this.Templates[6] = new Template("question", new Array(new Point(104,145),new Point(103,142),new Point(103,140),new Point(103,138),new Point(103,135),new Point(104,133),new Point(105,131),new Point(106,128),new Point(107,125),new Point(108,123),new Point(111,121),new Point(113,118),new Point(115,116),new Point(117,116),new Point(119,116),new Point(121,115),new Point(124,116),new Point(126,115),new Point(128,114),new Point(130,115),new Point(133,116),new Point(135,117),new Point(140,120),new Point(142,121),new Point(144,123),new Point(146,125),new Point(149,127),new Point(150,129),new Point(152,130),new Point(154,132),new Point(156,134),new Point(158,137),new Point(159,139),new Point(160,141),new Point(160,143),new Point(160,146),new Point(160,149),new Point(159,153),new Point(158,155),new Point(157,157),new Point(155,159),new Point(153,161),new Point(151,163),new Point(146,167),new Point(142,170),new Point(138,172),new Point(134,173),new Point(132,175),new Point(127,175),new Point(124,175),new Point(122,176),new Point(120,178),new Point(119,180),new Point(119,183),new Point(119,185),new Point(120,190),new Point(121,194),new Point(122,200),new Point(123,205),new Point(123,211),new Point(124,215),new Point(124,223),new Point(124,225)));
	...
	this.Templates[16] = new Template("recttest", new Array(new Point(78,133),new Point(78,230),new Point(201,230),new Point(201,133)));
	s="";
	alert(this.Templates[16].Points.length);
	for (i=0;i<this.Templates[16].Points.length;i++)
			s+=i+": "+this.Templates[16].Points[i].X+","+(-this.Templates[16].Points[i].Y)+"\n";
			alert(s);*/
	...
	this.Recognize = function(points)
	{
		...
		return new Result(this.Templates[t].Name, score, to_x, to_y, scale_x, scale_y, rot_a, rot_x, rot_y);
	};
	//
...
function ScaleToSquare(points, size)
{
	...
	var newpoints = new Array();
	scale_x=size / B.Width;
	scale_y=size / B.Height;
	for (var i = 0; i < points.length; i++)
	{
