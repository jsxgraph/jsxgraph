  ...
  JXG.extend(
    ...
    /** @lends JXG.GeogebraReader.prototype */ {
      ...
      ggbParse: function (exp, el) {
        ...
        function parse(src, err_off, err_la) {
          ...
          act_tab = [
            ...
            [
              /* "(" */ 2, 3, /* "!" */ 23, 4, /* "-" */ 12, 5,
              /* "STRING" */ 9, 6, /* "INT" */ 4, 7, /* "FLOAT" */ 5, 8,
              /* "PARAM" */ 6, 9, /* "HTML" */ 8, 10, /* "COMMAND" */ 10, 11,
              /* "VAR" */ 7, 12,
            ],
            /* State 1 */
            [/* "$$" */ 28, 0],
      ...
      checkElement: function (name) {
        ...
        if (
          !JXG.exists(this.ggbElements[name]) ||
          this.ggbElements[name] === ""
        ) {
      ...
      writeBoard: function () {
        ...
        this.board.fontSize =
          gui && gui.getElementsByTagName("font")[0]
            ? parseInt(
                gui.getElementsByTagName("font")[0].getAttribute("size"),
                10
              )
            : 12;
          ...
          case "function":
            ...
            try {
              ...
              if (length === 1) {
                ...
                p = this.board.create(
                  "functiongraph",
                  [new Function(func[0], func[1], func[2]), range[0], range[1]],
                  attr
                );
              } else if (length === 4) {
                p = this.board.create(
                ...
                p = this.board.create(
                  "functiongraph",
                  [
                    new Function(func[0], func[1], func[2], func[3], func[4]),
                    range[0],
                    range[1],
                  ],
                  attr
