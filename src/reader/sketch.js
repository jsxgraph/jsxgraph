      ...
      generateJCode: function (step, board, step_log) {
        ...
        switch (step.type) {
          ...
          case JXG.GENTYPE_TANGENT:
            ...
            set_str +=
              "', id: '" + step.dest_sub_ids[1] + "', priv: true>> >>; ";
          ...
          case JXG.GENTYPE_BISECTORLINES:
            ...
            set_str +=
              "', point1: <<id: '" + step.dest_sub_ids[4] + "', name: '";
            set_str +=
              "'>>, point2: <<id: '" + step.dest_sub_ids[3] + "', name: '";
            set_str += "'>>>>>>; ";
            reset_str =
              "remove(" +
              step.dest_sub_ids[5] +
          ...
          case JXG.GENTYPE_GLIDER:
            ...
            set_str +=
              step.dest_id + ".onPolygon = " + !!step.args.onPolygon + ";";
          ...
          case JXG.GENTYPE_LINE:
            ...
            if (step.args.create_point1) {
              ...
              set_str +=
                "snaptogrid: false, snaptopoints: false, priv: true>>; ";
              reset_str = "remove(" + pid1 + "); ";
            } else {
              pid1 = step.src_ids[j];
              j += 1;
          ...
          case JXG.GENTYPE_VECTOR:
            ...
            if (step.args.create_point2) {
              ...
              set_str +=
                ...
                "', name: '', visible: true, ";
              set_str +=
                "layer: " + JXG.Options.layer.line + ", opacity: 0.2, ";
              set_str +=
                "snaptogrid: " +
                JXG.Options.elements.snapToGrid +
                ", snaptopoints: false, priv: false>>; ";
          ...
          case JXG.GENTYPE_QUADRILATERAL:
            ...
            set_str += "', '";
            set_str +=
              step.dest_sub_ids[6] + "', '" + step.dest_sub_ids[7] + "' ]";
            set_str += ", names: ['', '', '', '']";
            set_str += ">>, " + attrid;
            set_str += " fillOpacity: ";
            set_str += JXG.Options.opacityLevel + ", name: '' ";
          ...
          case JXG.GENTYPE_REGULARPOLYGON:
            set_str =
              assign + "regularpolygon(" + step.src_ids.join(", ") + ", ";
          ...
          case JXG.GENTYPE_NONREFLEXANGLE:
            set_str =
              assign + "nonreflexangle(" + step.src_ids.join(", ") + ") ";
            set_str += "<<";
          ...
          case JXG.GENTYPE_SLOPETRIANGLE:
            ...
            set_str =
              assign + "slopetriangle(" + step.src_ids.join(", ") + ") <<";
            set_str += attrid + " name: '',";
            set_str +=
              "borders:   <<ids: ['" +
              step.dest_sub_ids[4] +
          ...
          case JXG.GENTYPE_COPY:
            ...
            for (j = 0; j < step.args.map.length; j++) {
              ...
              if (
                el.type === JXG.OBJECT_TYPE_CIRCLE &&
                !JXG.exists(el.point2)
              ) {
          ...
          case JXG.GENTYPE_ABLATION:
            ...
            set_str =
              ...
              ") <<id: '";
            set_str +=
              step.dest_sub_ids[0] + "', name: '', withLabel: false>>; ";
            set_str +=
              "circle('" +
              step.dest_sub_ids[0] +
              "', 1) <<id: '" +
