 ...
 * @param {Board} board Reference to the board the sector is drawn on.
 * @param {Point} p1 Midpoint of the sector.
 * @param {Point} p2 Point defining the sectors radius
 * @param {Point} p3 This point defines the angle of the sectors section.
