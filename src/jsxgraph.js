...
define([
  ...
  JXG.JSXGraph = {
    ...
    _setAttributes: function (attributes) {
      ...
      attr.screenshot = Type.copyAttributes(
        attr,
        Options,
        "board",
        "screenshot"
      ...
      attr.fullscreen = Type.copyAttributes(
        attr,
        Options,
        "board",
        "fullscreen"
    ...
    initBoard: function (box, attributes) {
      ...
      if (attr.grid) {
        board.create(
          "grid",
          [],
          typeof attr.grid === "object" ? attr.grid : {}
        );
      }
      ...
      function () {
        ...
        for (i = 0; i < scripts.length; i++) {
          ...
          if (
            ...
            aspectRatio =
              scripts[i].getAttribute("aspectratio", false) || "1/1";
            bbox =
              scripts[i].getAttribute("boundingbox", false) || "-5, 5, 5, -5";
            ...
            axis = Type.str2Bool(
              scripts[i].getAttribute("axis", false) || "false"
            );
            grid = Type.str2Bool(
              scripts[i].getAttribute("grid", false) || "false"
            );
