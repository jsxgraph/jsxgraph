  ...
  JXG.createParallelPoint = function (board, parents, attributes) {
    ...
    p = board.create(
      ...
      [
        function () {
          return (
            c.coords.usrCoords[1] +
            b.coords.usrCoords[1] -
            a.coords.usrCoords[1]
          );
        },
        function () {
          return (
            c.coords.usrCoords[2] +
            b.coords.usrCoords[2] -
            a.coords.usrCoords[2]
          );
        },
      ],
      attributes
