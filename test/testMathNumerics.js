...
describe("Test JXG.Math.Numerics", function () {
  ...
  it("Spline evaluation", function () {
    ...
    expect(JXG.Math.Numerics.splineEval([1.5, 2.5], x, y, F)).toEqual([
      1.5, 2.5,
    ]);
  });
  ...
  it("General polynomial term", function () {
    ...
    expect(
      JXG.Math.Numerics.generatePolynomialTerm(coeff, deg, varname, prec)
    ).toEqual(
  ...
  it("Regression polynomial", function () {
    ...
    regressionArrays = JXG.Math.Numerics.regressionPolynomial(
      fakeSlider,
      P[0],
      P[1]
    );
